...
void drawReleysAndTemp(uint8_t active, float temp)
{
    uint8_t top = 8;
    oled.rect(4, top, 36, top + 7, active == 0 ? OLED_FILL : OLED_STROKE);
    oled.rect(92, top, 124, top + 7, active == 1 ? OLED_FILL : OLED_STROKE);
    oled.setScale(1);
